...
int registrationSuspendInd(int slotId, int indType, int token,
			   RIL_Errno e, void *response, size_t responselen);

// RIL_UNSOL_INCOMING_CALL_INDICATION
int incomingCallInd(int slotId, int indType, int token,
		    RIL_Errno e, void *response, size_t responselen);
...
int psNetworkStateChangedInd(int slotId, int indType, int token,
			     RIL_Errno e, void *response, size_t responseLen);

// RIL_UNSOL_SET_ATTACH_APN
int setAttachApnInd(int slotId, int indType, int token,
		    RIL_Errno e, void *response, size_t responselen);

bool isServiceConnected(int slotId);
